class TicTacToe{
    ...
    setPlayerX(value){
        this.playerXName=value;
    }
    setPlayerY(value){
        this.playerYName=value;
    }
}

const ticTacToe =  new TicTacToe()

// const saveNameOne = document.querySelector(".player-X").value;
// if(saveNameOne !=="") setPlayerX(saveNameOne);

// const saveNameTwo = document.querySelector(".player-O").value;
// if(saveNameTwo !=="") setPlayerY(saveNameTwo);
